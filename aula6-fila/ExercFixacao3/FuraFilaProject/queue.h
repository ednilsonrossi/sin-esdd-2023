...
/**
 * Operação de furar a fila. Essa operação contraria 
 * a regra de negócio original de uma fila e insere 
 * um novo elemento no início da fila.
*/
bool fura_fila(Queue queue, Element new_element);
